...
# to be written live
intc = data.get_data_yahoo('INTC', start=datetime.datetime(2010, 10, 1),
                           end=datetime.datetime(2023, 1, 1))
nvda = data.get_data_yahoo('NVDA', start=datetime.datetime(2010, 10, 1),
                           end=datetime.datetime(2023, 1, 1))
plt.plot(aapl['Adj Close'], label="AAPL")
plt.plot(intc['Adj Close'], label="INTC")
plt.plot(nvda['Adj Close'], label="NVDA")  # arm deal
plt.legend()
plt.show()
#################
